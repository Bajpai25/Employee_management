...
function Employee() {
  ...
  async function get_data(){
    const response=await fetch('http://ec2-3-111-31-17.ap-south-1.compute.amazonaws.com:5000/getdata');
  ...
  async function handle_click(id){
    const response = await fetch('http://ec2-3-111-31-17.ap-south-1.compute.amazonaws.com:5000/delete/'+id,{
      method:'DELETE',
    })
