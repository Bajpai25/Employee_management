...
function Employee_edit() {
  ...
  async function get_data_id(){
    const response=await fetch('http://ec2-3-111-31-17.ap-south-1.compute.amazonaws.com:5000/get/'+id);
  ...
  async function updatedata(e){
    e.preventDefault();
    try{
      const response=await fetch('http://ec2-3-111-31-17.ap-south-1.compute.amazonaws.com:5000/update/'+id,{
